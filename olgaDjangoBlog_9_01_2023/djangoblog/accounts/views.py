...
class LoginView(FormView):
    ...
    login_ttl = 2626560  # время месяца
...
def account_result(request):
    ...
    на ваш почтовый ящик, войдите на этот сайт 
    ...
    '''
            ...
            content = '''
            Поздравляем,
            вы успешно завершили проверку
            электронной почты, теперь вы можете использовать
            свою учетную запись для входа на этот сайт.
            '''
