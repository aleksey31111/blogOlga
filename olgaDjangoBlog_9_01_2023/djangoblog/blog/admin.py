...
makr_article_publish.short_description = 'Публиковать избранные статьи'
draft_article.short_description = 'Выбрать статью как черновик'
close_article_commentstatus.short_description = 'Закрыть комментарии к статье'
open_article_commentstatus.short_description = 'Открыть комментарий к статье'
